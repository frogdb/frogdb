...
| Rulings | [issue 09](../.scratch/spec-gaps/issues/open/09-routing-epoch-carry-and-watch-recheck.md) |
| Pending | [issue 09](../.scratch/spec-gaps/issues/open/09-routing-epoch-carry-and-watch-recheck.md) — no epoch is carried on the shard message today; the window is real and unclosed |
