...
| Rulings | [issue 25](../.scratch/spec-gaps/issues/done/25-take-folds-only-live-watched-shards.md) — the fold filters on `live_at_watch` (code matches the row, which already said *live*); dead watches route to their own shard |
