...
| Forced by | `an_unrelated_file_in_the_data_dir_refuses_the_boot`, `the_data_dir_guard_runs_before_a_staged_checkpoint_can_install`, `force_fresh_data_dir_refuses_beside_foreign_entries`, `force_fresh_data_dir_is_not_settable_from_the_config_file`, `foreign_files_names_entries_up_to_the_limit` |
| Bug refs | `.scratch/hardening/issues/done/11-wrong-data-dir-boots-as-a-fresh-database.md`; `.scratch/spec-gaps/issues/done/32-force-fresh-data-dir-refuses-foreign-entries.md` (R6: the flag becomes a fresh-start tool, not an override) |
