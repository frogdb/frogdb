...
|---|---|--:|--:|---|
| [memory-architecture](memory-architecture/) | active | 12 | 24 | 2026-08-31 memory-architecture PRD (R1–R15, all ruled) + phase-1 spike (GO); phases 1–2 landed (issues 01–09); phase 3–6 issues 10, 13–22 filed 2026-09-01; 11–12 drafted from the landed slot-layout spike report; 23 filed from issue 18's review (replica feed accounting, D4); 14, 15, 16, 17, 18, 20 landed 2026-09-02; 21 landed 2026-09-04; 23 landed 2026-09-05; 11 landed 2026-09-05; 12 landed 2026-09-05; 22 landed 2026-09-05 (spec LOCKED, memory is the fifth locked area; drafts 24–28 filed from its audit, needs-triage); whole-branch review 2026-09-05: fix round landed, drafts 29–31 filed (needs-triage), 19 closed as landed with its Linux-rig residue split to 32 (ready-for-human); build-toolchain thread 2026-09-04–05: 33 (cluster-suite regression, done), 34 (jemalloc arenas in test binaries), 35 (heartbeat-derived handoff budget, D5), 36 (malloc_conf on Linux) — renumbered from 24–27 on merge |
...
Totals: **133 open, 129 done**. `done/` holds only closed issues still referenced from
