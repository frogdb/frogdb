...
|---|---|--:|--:|---|
| [memory-architecture](memory-architecture/) | active | 10 | 24 | 2026-08-31 memory-architecture PRD (R1–R15, all ruled) + phase-1 spike (GO); phases 1–2 landed (issues 01–09); phase 3–6 issues 10, 13–22 filed 2026-09-01; 11–12 drafted from the landed slot-layout spike report; 23 filed from issue 18's review (replica feed accounting, D4); 14, 15, 16, 17, 18, 20 landed 2026-09-02; 21 landed 2026-09-04; 23 landed 2026-09-05; 11 landed 2026-09-05; 12 landed 2026-09-05; 22 landed 2026-09-05 (spec LOCKED, memory is the fifth locked area; drafts 24–28 filed from its audit, needs-triage); whole-branch review 2026-09-05: fix round landed, drafts 29–31 filed (needs-triage), 19 closed as landed with its Linux-rig residue split to 32 (ready-for-human); follow-up round 2026-09-05 (D7): 33–34 filed from the re-review nits, 28/33/34 dispatched; 33 landed 2026-09-05 |
| [build-cache](build-cache/) | active | — | — | 2026-09-06 sccache re-investigation: shim root cause, cross-worktree ceiling, waste measurements, rejected alternatives; Tier 2 (`seed-target`) spike status |
...
| [concurrency-testing](concurrency-testing/) | active | 4 | 8 | concurrency invariant testing; phases 1–5 shipped. Issue 11's findings re-verified 2026-08-02 and split into issues 12–16 — one real product bug (12), the rest harness/checker defects. Issue 18 closed 2026-09-01: turmoil reds fixed, LOCKED-spec wording amended (human-approved). Issue 19 closed 2026-09-06: sccache bypasses were hiding a broken mise-shim `RUSTC_WRAPPER` |
...
Totals: **109 open, 120 done**. `done/` holds only closed issues still referenced from
