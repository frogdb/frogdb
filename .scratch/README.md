...
|---|---|--:|--:|---|
| [memory-architecture](memory-architecture/) | active | 1 | 6 | 2026-08-31 memory-architecture PRD (R1–R15, all ruled) + phase-1 spike (GO); kickoff artifacts: `specs/memory.md` (DRAFT), `adr/0006`, phase-1/2 issues 01–06 |
...
Totals: **99 open, 102 done**. `done/` holds only closed issues still referenced from
