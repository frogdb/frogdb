...
|---|---|--:|--:|---|
| [memory-architecture](memory-architecture/) | active | 3 | 20 | 2026-08-31 memory-architecture PRD (R1–R15, all ruled) + phase-1 spike (GO); phases 1–2 landed (issues 01–09); phase 3–6 issues 10, 13–22 filed 2026-09-01; 11–12 drafted from the landed slot-layout spike report; 23 filed from issue 18's review (replica feed accounting, D4); 14, 15, 16, 17, 18, 20 landed 2026-09-02; 21 landed 2026-09-04; 23 landed 2026-09-05; 11 landed 2026-09-05 |
...
Totals: **102 open, 116 done**. `done/` holds only closed issues still referenced from
