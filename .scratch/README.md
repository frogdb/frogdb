...
|---|---|--:|--:|---|
| [memory-architecture](memory-architecture/) | active | 14 | 24 | 2026-08-31 memory-architecture PRD (R1–R15, all ruled) + phase-1 spike (GO); phases 1–2 landed (issues 01–09); phase 3–6 issues 10, 13–22 filed 2026-09-01; 11–12 drafted from the landed slot-layout spike report; 23 filed from issue 18's review (replica feed accounting, D4); 14, 15, 16, 17, 18, 20 landed 2026-09-02; 21 landed 2026-09-04; 23 landed 2026-09-05; 11 landed 2026-09-05; 12 landed 2026-09-05; 22 landed 2026-09-05 (spec LOCKED, memory is the fifth locked area; drafts 24–28 filed from its audit, needs-triage); whole-branch review 2026-09-05: fix round landed, drafts 29–31 filed (needs-triage), 19 closed as landed with its Linux-rig residue split to 32 (ready-for-human); follow-up round 2026-09-05 (D7): 33–34 filed from the re-review nits, 28/33/34 dispatched; build-toolchain thread 2026-09-04–05: 35 (cluster-suite regression, done), 36 (jemalloc arenas in test binaries), 37 (heartbeat-derived handoff budget, D5), 38 (malloc_conf on Linux) — renumbered from 24–27 and again from 33–36 on the two main merges |
...
| [build-toolchain](build-toolchain/) | active | 1 | 9 | build/CI-toolchain/release-path defects, where dev builds stay green but a shipping or gating path is broken; opened 2026-09-02 with `just cross-build` failing on usearch under zig; 02 filed 2026-09-04 for `main` CI red on seven jobs, landed same day on `build-toolchain/impl`; 03 filed 2026-09-04 when that branch's CI run showed the mise pin from 02 ineffective, landed same day; 04–07 filed 2026-09-04 from the first full CI run after 03 (npm-backend node dependency, h2 advisory, 15 s nextest timeouts, config golden counts on Linux); 01 landed 2026-09-04 (target-scoped CXXFLAGS + `AR="zig ar"` for autoconf jemalloc); 04 landed 2026-09-04 (`node` ahead of the `npm:` quint tool); 05 landed 2026-09-04 (h2 0.4.19, RUSTSEC-2026-0258); 08 filed 2026-09-04 from the whole-branch review; 09 carved 2026-09-05 from 06 (quint evaluator warm-up, D6), landed 2026-09-05 (`6a31b6026`); 10 carved 2026-09-05 from 06 B (nextest overrides for six heavy tests, D7), landed 2026-09-05 (`109736bb9`); 08 (the PRD's "Detection gap": no CI job runs `just cross-build`, `zig` floats in `.mise.toml`) specified 2026-09-05 as a per-push `cross-build` job plus zig pin (D9); 06 closed 2026-09-05 per D8 (A→09, B→10, C a one-off: probe 33984698301 green); 07 closed 2026-09-05 per D10 (resolved by memory-architecture #21 `98599d0d2`) |
| [roadmap](roadmap/) | active | — | — | roadmap + unfinished/follow-up items (migrated from the retired `todo/`); not an issue tracker |

Totals: **133 open, 131 done**. `done/` holds only closed issues still referenced from
