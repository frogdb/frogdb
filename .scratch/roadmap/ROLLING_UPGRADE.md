...
**Status:** Partially implemented — version tracking, `ClusterCommand::FinalizeUpgrade`, and
the `frog upgrade` CLI exist; audit this spec against the code before resuming the remainder.
