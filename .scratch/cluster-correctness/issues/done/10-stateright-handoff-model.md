...
One, and it maps to neither issue 14 nor issue 15: **issue 16** — a source whose apply of
...
Filed as `.scratch/cluster-correctness/issues/open/16-stale-source-outlives-its-write-barrier.md`
