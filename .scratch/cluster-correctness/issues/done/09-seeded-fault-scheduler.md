...
- `just cluster-seeds 500` (`CLUSTER_SEEDS_JOBS=6`), the ruled nightly budget: 592s, **36 of
  the 490 unmuzzled seeds fail, all issue 20** (seeds 113, 125, 126, 138, 143, 157, 159, 162,
  ...
  signature). They are recorded in issue 20 rather than muzzled individually: 46 replays of
  one defect would cost the per-PR suite minutes and add nothing over the canonical seeds 3
  and 72. Nightly therefore stays red until issue 20 lands, and issue 20's acceptance
