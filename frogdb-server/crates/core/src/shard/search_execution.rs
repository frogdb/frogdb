...
impl ShardWorker {
    pub(super) async fn execute_ft_create(
        &mut self,
    ...
    pub(super) fn execute_ft_search(
        &mut self,
        index_name: &Bytes,
        query_args: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_aggregate(
        &mut self,
        index_name: &Bytes,
        query_args: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_hybrid(
        &mut self,
        index_name: &Bytes,
        query_args: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) async fn execute_ft_dropindex(
        &mut self,
        index_name: &Bytes,
    ) -> Vec<(Bytes, Response)> {
        let name = std::str::from_utf8(index_name).unwrap_or("");
    ...
    pub(super) fn execute_ft_info(&self, index_name: &Bytes) -> Vec<(Bytes, Response)> {
        let name = std::str::from_utf8(index_name).unwrap_or("");
        let name = self.resolve_index_name(name);
        let idx = match self.search_indexes.get(name) {
            Some(idx) => idx,
    ...
    pub(super) fn execute_ft_list(&self) -> Vec<(Bytes, Response)> {
    ...
    pub(super) async fn execute_ft_alter(
        &mut self,
        index_name: &Bytes,
    ...
    pub(super) async fn execute_ft_synupdate(
        &mut self,
        index_name: &Bytes,
        group_id: &Bytes,
        terms: &[Bytes],
    ...
    pub(super) fn execute_ft_syndump(&self, index_name: &Bytes) -> Vec<(Bytes, Response)> {
        let name = std::str::from_utf8(index_name).unwrap_or("");
        let name = self.resolve_index_name(name);
        let idx = match self.search_indexes.get(name) {
            Some(idx) => idx,
...
impl ShardWorker {
    ...
    pub(super) fn resolve_index_name<'a>(&'a self, name: &'a str) -> &'a str {
        self.index_aliases
            .get(name)
            .map(|s| s.as_str())
            .unwrap_or(name)
    ...
    pub(super) fn execute_ft_aliasadd(
        &mut self,
        alias_name: &Bytes,
        index_name: &Bytes,
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_aliasdel(&mut self, alias_name: &Bytes) -> Vec<(Bytes, Response)> {
        let alias = std::str::from_utf8(alias_name).unwrap_or("");
    ...
    pub(super) fn execute_ft_aliasupdate(
        &mut self,
        alias_name: &Bytes,
        index_name: &Bytes,
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_tagvals(
        &self,
        index_name: &Bytes,
        field_name: &Bytes,
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_dictadd(
        &mut self,
        dict_name: &Bytes,
        terms: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_dictdel(
        &mut self,
        dict_name: &Bytes,
        terms: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_dictdump(&self, dict_name: &Bytes) -> Vec<(Bytes, Response)> {
        let name = std::str::from_utf8(dict_name).unwrap_or("");
    ...
    pub(super) fn execute_ft_config(&mut self, args: &[Bytes]) -> Vec<(Bytes, Response)> {
        if args.is_empty() {
            return vec![(
    ...
    pub(super) fn execute_ft_config_set(
        &mut self,
        param: &str,
        value: &str,
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_spellcheck(
        &self,
        index_name: &Bytes,
        query_args: &[Bytes],
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn execute_ft_explain(
        &self,
        index_name: &Bytes,
        query_str: &Bytes,
    ) -> Vec<(Bytes, Response)> {
    ...
    pub(super) fn persist_aliases(&self) {
        if let Some(ref rocks) = self.persistence.rocks_store
    ...
    pub(super) fn persist_dict(&self, dict_name: &str) {
        if let Some(ref rocks) = self.persistence.rocks_store {
    ...
    pub(super) fn persist_search_config(&self) {
        if let Some(ref rocks) = self.persistence.rocks_store
