...
fn seed_sweep_nightly() {
    ...
    // ops — see .scratch/concurrency-testing/issues/11-nightly-smoke-findings.md, Finding A;
...
mod regressions {
    ...
    /// the entirety of `.scratch/concurrency-testing/issues/11-nightly-smoke-findings.md`
