...
<Aside type="note">
This reference is manually maintained. The canonical metric definitions are in `frogdb-server/crates/telemetry/src/definitions.rs`. If you add a new metric, update this page to match.
</Aside>
