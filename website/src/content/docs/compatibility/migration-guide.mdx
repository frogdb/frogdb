...
```bash
# Benchmark FrogDB
frogdb-benchmark -h localhost -p 6380 -c 50 -n 100000
...
- [Redis Differences](/compatibility/redis-differences/) — Compatibility details
- [Configuration Reference](/reference/configuration/) — FrogDB configuration
