...
[issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) — the ruling
...
| Forced by | MISSING ([issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md)) — no test exercises `max_waiters_per_key`/`max_blocked_connections` refusal at all; this is the current-code cell C1 exists to fix, tracked by the same issue as the `Pending` ruling. |
| Rulings | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) (H7) |
| Pending | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) |
...
| Rulings | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) (confirms this path, no code gap) |
...
| Forced by | `channel_drop_yields_null_response` forces the `(current code)` cell only, per FM-BLOCKING-004; the `(ruled)` cell is `MISSING ([issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md))` — a forcing test must not be written against it until the ruling lands. |
| Rulings | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) (H5) |
| Pending | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) |
...
| Forced by | MISSING ([issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md)) — the `(ruled)` cell has no code to test yet; the `(current code)` cell's hazard (a demoted shard's replicated write serving a local waiter) is likewise not forced by any located test, consistent with it being an undetected gap rather than a deliberately accepted one. |
| Rulings | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) (H6) |
| Pending | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) |
...
| Rulings | [issue 08](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/08-blocking-command-rows.md) (confirms this path already exists and is correct, unrowed until now) |
