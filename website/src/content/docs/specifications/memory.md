...
lint in the family described in [`agents/seam-lints.md`](https://github.com/frogdb/frogdb/blob/main/agents/seam-lints.md), pinning
...
([issue 66](https://github.com/frogdb/frogdb/blob/main/.scratch/testing-improvements-round2/issues)), and the replica-feed hold
buffer, whose byte cap [cluster.md TR-CLUSTER-016](/specifications/cluster/#tr-cluster-016--replica-feed-hold-during-an-armed-slot-barrier)
...
between (see [spike-report.md](https://github.com/frogdb/frogdb/blob/main/.scratch/memory-architecture/spike-report.md) §(a) E4/E5).
...
(see [spike-report.md](https://github.com/frogdb/frogdb/blob/main/.scratch/memory-architecture/spike-report.md) §(c)).
...
* [cluster.md TR-CLUSTER-016](/specifications/cluster/#tr-cluster-016--replica-feed-hold-during-an-armed-slot-barrier)'s
...
[persistence.md](/specifications/persistence/) owns durability ordering and the write-group atomicity this
spec's transaction cap bounds. [replication.md](/specifications/replication/) owns what crosses the link;
