---
title: "Persistence — failure modes"
description: "WAL, checkpoints, recovery, and durability acknowledgement."
sidebar:
  order: 3
---
<!-- DO NOT EDIT — auto-generated by: just spec-gen (source: specs/persistence.md) -->
...
live in [Transactions — failure modes](/specifications/txn/).
...
landed yet. Ruling authority for this section: [issue 01](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/01-sync-durability-must-gate-the-ack.md),
[issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/02-durability-failure-taxonomy.md),
[issue 03](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/03-enable-rocksdb-atomic-flush.md),
[issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md),
[issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/05-persistence-advisory-sweep.md), and the persistence
addendum (R4-R6) of [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md).
...
| Rulings | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/05-persistence-advisory-sweep.md) (the variant's rename to `Committed`, no semantic change to this row) |
...
| Rulings | [issue 01](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/01-sync-durability-must-gate-the-ack.md) |
...
| Rulings | [issue 26](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/26-distsys-review-minors-sweep.md) (MIN-6): the no-torn-body argument used to rest on ext4's `auto_da_alloc` without saying so. Replaced by a checksummed body, which holds on any filesystem an operator picks — the row states the mechanism rather than the mount option. (MIN-11): (b)'s group-commit assumption was uncited and untested — the upstream rule is now named above and pinned by a concurrent mixed-flag test. |
...
| Rulings | [issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/02-durability-failure-taxonomy.md) (H2 / "Suffix restoration") |
...
| Rulings | [issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/02-durability-failure-taxonomy.md) |
...
| Rulings | [issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/02-durability-failure-taxonomy.md) (H1 / fsyncgate) |
...
| Rulings | [issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/02-durability-failure-taxonomy.md) (A2) |
...
| Rulings | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) |
| Pending | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) |
...
| Rulings | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) (item 2) |
| Pending | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) (item 2) |
...
| Source | not yet implemented |
| Rulings | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) (item 6, Finding A4) |
| Pending | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) (item 6, Finding A4) |
...
| Rulings | [issue 03](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/03-enable-rocksdb-atomic-flush.md) |
| Pending | [issue 03](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/03-enable-rocksdb-atomic-flush.md) |
...
| Rulings | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Ruling + Amendment) |
| Pending | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Ruling + Amendment) |
...
| Rulings | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Amendment, point 4) |
| Pending | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Amendment, point 4) |
...
| Source | not yet implemented |
| Rulings | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) |
| Pending | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) |
...
| Source | not yet implemented |
| Rulings | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R6) |
| Pending | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R6) |
...
| Rulings | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) — sole owner: [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/05-persistence-advisory-sweep.md) deferred the consumer to it rather than inventing an expected-id knob with no reader |
| Pending | [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) |
...
| Invariant | `ShardWorker::execute_transaction` computes the footprint and `grow`s a fresh `Charge` on the shard's own `Subsystem::TxnBuffering` budget **after** every admission gate (routing fence, rate limiter, watch check, minted-fence verify) and **before** the apply loop; a `Refused` returns `TransactionResult::Error` with the OOM text and falls through none of the apply, persist or write-effect paths. The charge is a local dropped at the end of the call, so every exit — refusal, a WAL rollback, a panic isolated by `panic_guard`, a normal commit — releases it. The charge site and its forcing tests live in `frogdb-core` (where staging lives), like FM-PERSISTENCE-001's shard-side tests, so this row sits outside the `frogdb-persistence` mutation gate. The queue-time half of the same bound is [txn.md FM-TXN-054](/specifications/txn/#fm-txn-054--a-multi-that-outgrows-the-transaction-buffer-is-poisoned-at-queue-time); the replica-side pending group is [replication.md FM-REPLICATION-045](/specifications/replication/#fm-replication-045--an-unterminated-replicated-multi-is-bounded-and-abandoned-never-accumulated). **Known gap:** because the connection releases its charge before the round trip and this one opens fresh, the batch is charged to nobody while it sits in the shard's channel — the same window FM-TXN-054 names, seen from the receiving end, and the reason the limit is not a bound on resident bytes under a slow shard; carrying the `Charge` in `CoreMsg::ExecTransaction` and growing it here instead is [memory-architecture issue 29](https://github.com/frogdb/frogdb/blob/main/.scratch/memory-architecture/issues/open/29-txn-charge-through-shard-channel.md). |
...
| Bug refs | [memory-architecture issue 21](https://github.com/frogdb/frogdb/blob/main/.scratch/memory-architecture/issues/done/21-txn-budget-hard-cap.md) |
...
shape of the bound. They live in this spec rather than in [`memory.md`](/specifications/memory/) because both
...
| Bug refs | [memory-architecture issue 06](https://github.com/frogdb/frogdb/blob/main/.scratch/memory-architecture/issues/done/06-rocksdb-jemalloc-budget.md) (PRD ruling R10) |
