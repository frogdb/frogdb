...
[issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md), and the persistence
...
| Rulings | — |
| Pending | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md) — `Durability::Confirm` is ruled to be renamed (see TR-PERSISTENCE-005); no semantic change to this row |
...
| Rulings | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md) |
| Pending | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md) |
...
| Rulings | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) — ruled to become a monotone counter seeded from the highest existing suffix, not wall-clock seconds (an NTP step back, or two installs inside one second, currently corrupt the retention ordering) |
| Pending | [issue 04](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/04-staged-checkpoint-install-verification.md) — ruled to become a monotone counter, not wall-clock seconds |
...
| Rulings | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md); [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) |
| Pending | [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md); [replication issue 24](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-correctness/issues/open/24-a-restart-keeps-the-replication-id-it-lost-the-history-for.md) (Addendum R4) |
