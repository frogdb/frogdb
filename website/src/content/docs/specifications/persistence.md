...
landed yet. Ruling authority for this section: [issue 01](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/01-sync-durability-must-gate-the-ack.md),
...
| Rulings | [issue 01](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/01-sync-durability-must-gate-the-ack.md) |
| Pending | [issue 01](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/01-sync-durability-must-gate-the-ack.md); [issue 05](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/05-persistence-advisory-sweep.md) (open: whether `Sync` additionally binds to `synced_seq`) |
