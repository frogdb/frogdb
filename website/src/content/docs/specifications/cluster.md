...
description: "Cluster topology, slot ownership, migration, and failover."
sidebar:
  order: 1
---
<!-- DO NOT EDIT — auto-generated by: just spec-gen (source: specs/cluster.md) -->
...
[rework issue 02](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-cluster-rework/issues/done/02-migration-finalization-pause-barrier.md)
...
[`cluster_admission.qnt`](https://github.com/frogdb/frogdb/blob/main/specs/quint/cluster_admission.qnt) covers the bootstrap/join/MEET
...
quint-connect conformance harness in [`quint_conformance.rs`](https://github.com/frogdb/frogdb/blob/main/frogdb-server/crates/cluster/tests/quint_conformance.rs);
...
| Rulings | Issue 30 |
| Pending | [issue 30](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/open/30-config-set-replica-priority-re-registers-through-raft.md) |
...
| Bug refs | fixed: [33-remove-slots-is-owner-blind.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/33-remove-slots-is-owner-blind.md) |
...
| Bug refs | fixed: [39-cluster-reset-bypasses-the-cluster-writer.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/39-cluster-reset-bypasses-the-cluster-writer.md) |
...
| Bug refs | fixed: [34-finalize-upgrade-accepts-garbage-with-no-nodes.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/34-finalize-upgrade-accepts-garbage-with-no-nodes.md) |
...
| Bug refs | fixed: [38-set-config-epoch-discards-its-argument.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/38-set-config-epoch-discards-its-argument.md) |
...
| Bug refs | fixed: [35-migration-complete-event-dropped-when-target-unknown.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/35-migration-complete-event-dropped-when-target-unknown.md) |
...
| Bug refs | fixed: [36-spublish-conflates-unowned-slot-with-local-ownership.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/36-spublish-conflates-unowned-slot-with-local-ownership.md); ruled: [21-spublish-refusal-semantics.md](https://github.com/frogdb/frogdb/blob/main/.scratch/redis-feel/issues/done/21-spublish-refusal-semantics.md) |
...
| Bug refs | fixed: [37-cluster-stats-messages-hardcoded-zero.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening/issues/done/37-cluster-stats-messages-hardcoded-zero.md) |
...
| Bug refs | fixed: [10-cluster-snapshot-clone-cost.md](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-cluster-rework/issues/done/10-cluster-snapshot-clone-cost.md) |
...
| Bug refs | [02-migration-finalization-pause-barrier.md](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-cluster-rework/issues/done/02-migration-finalization-pause-barrier.md) |
...
| Bug refs | [12-barrier-vs-replica-feed-policy.md](https://github.com/frogdb/frogdb/blob/main/.scratch/replication-cluster-rework/issues/done/12-barrier-vs-replica-feed-policy.md) |
...
| Bug refs | fixed: [01-save-vote-flushes-the-wrong-column-family.md](https://github.com/frogdb/frogdb/blob/main/.scratch/hardening-2/issues/done/01-save-vote-flushes-the-wrong-column-family.md) |
...
[73](https://github.com/frogdb/frogdb/blob/main/.scratch/testing-improvements-round2/issues) as much as to this row; `append` acks a log write
...
| Bug refs | fixed: [53-stale-raft-log-reader-cache.md](https://github.com/frogdb/frogdb/blob/main/.scratch/testing-improvements-round2/issues/done/53-stale-raft-log-reader-cache.md) |
...
([issue 21](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/21-no-layer-sees-the-raft-log-store.md)) — the
...
| Bug refs | [87-cluster-residual-test-gaps.md](https://github.com/frogdb/frogdb/blob/main/.scratch/testing-improvements-round2/issues/open/87-cluster-residual-test-gaps.md) |
...
| Bug refs | fixed: [21-no-layer-sees-the-raft-log-store.md](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/21-no-layer-sees-the-raft-log-store.md) |

Found by the layer [issue 21](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/21-no-layer-sees-the-raft-log-store.md)
...
| Bug refs | [37-promotion-validity-bound-offset-unknown-last.md](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/37-promotion-validity-bound-offset-unknown-last.md) |
...
| Bug refs | [42-departing-replica-promotion-eligibility-under-handoff.md](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/42-departing-replica-promotion-eligibility-under-handoff.md) |
...
| Bug refs | [40-read-consistency-contract-and-serve-stale-knob.md](https://github.com/frogdb/frogdb/blob/main/.scratch/cluster-correctness/issues/done/40-read-consistency-contract-and-serve-stale-knob.md) |
