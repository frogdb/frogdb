...
| Rulings | [issue 07](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/done/07-vll-continuation-package.md) |
| Pending | [issue 28](https://github.com/frogdb/frogdb/blob/main/.scratch/spec-gaps/issues/open/28-vll-panic-restarts-the-shard-from-wal.md) — WAL-restart-on-panic is not yet built (no shard-restart mechanism exists to build it on); today's isolation relies on `catch_unwind` alone |
