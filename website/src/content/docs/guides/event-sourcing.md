...
description: "FrogDB provides first-class event sourcing primitives built on top of Redis Streams. These commands are a FrogDB extension and are not available in Redis, Va..."
sidebar:
  order: 7
---
