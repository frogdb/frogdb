...
description: "FrogDB supports backup and recovery through snapshots, WAL files, and replica-based strategies."
sidebar:
  order: 5
---
...
See [replication.md](/operations/replication/) for configuring replicas.
...
If WAL corruption is detected on startup, see [persistence.md](/operations/persistence/) for WAL corruption recovery options.
