...
cargo run --release -- -c tools/loadtest/configs/frogdb-periodic.toml
```
...
uv run tools/loadtest/scripts/run_redis_benchmark.py

# Comprehensive test with memtier_benchmark
uv run tools/loadtest/scripts/run_memtier.py

# Predefined workload
uv run tools/loadtest/scripts/run_memtier.py -w read-heavy
```
...
# Run comparison
uv run tools/loadtest/scripts/compare_redis.py
```
...
```bash
# Async (fastest)
cargo run --release -- -c tools/loadtest/configs/frogdb-async.toml &
uv run tools/loadtest/scripts/run_memtier.py -w write-heavy --json reports/async.json

# Periodic (balanced)
cargo run --release -- -c tools/loadtest/configs/frogdb-periodic.toml &
uv run tools/loadtest/scripts/run_memtier.py -w write-heavy --json reports/periodic.json

# Sync (most durable)
cargo run --release -- -c tools/loadtest/configs/frogdb-sync.toml &
uv run tools/loadtest/scripts/run_memtier.py -w write-heavy --json reports/sync.json

# Compare results
uv run tools/loadtest/scripts/parse_results.py --frogdb reports/periodic.json
```
