...
See [vll.md](vll.md) for full VLL type definitions.
...
FrogDB uses a [VLL](vll.md)-inspired (Very Lightweight Locking) approach for multi-shard atomicity. This provides atomic execution without mutex contention.

See [vll.md](vll.md) for the complete VLL design including goals, key concepts, and details.
