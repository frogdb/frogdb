...
Error handling uses a `CommandError` enum with variants for wrong arity, wrong type, syntax errors, out-of-range values, and other command-specific errors. See [architecture.md](architecture.md) for the key error variants.
