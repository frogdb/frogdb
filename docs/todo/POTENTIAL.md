...
- **Dashtable implementation** (from STORAGE.md,
  EVICTION.md) — DragonflyDB's custom hash table based on "Dash: Scalable
...
- **DragonflyDB 2Q LFRU algorithm** (from EVICTION.md) — 2Q algorithm (1994
...
- **Per-field tiering** (from TIERED.md) — Keep collection scaffolding in RAM,
...
- **Future enhancements table** (from TIERED.md):
...
- **mTLS CN/SAN to ACL user mapping** (from TLS.md) — Map client certificate
  ...
  authentication mechanism. See AUTH.md for the ACL system.
