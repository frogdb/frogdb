...
**Known Limitation:** DUMP/RESTORE serialization for Stream, BloomFilter, and TimeSeries values currently returns empty bytes — data is silently lost. See [INDEX.md](../../todo/INDEX.md) for details.
