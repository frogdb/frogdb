...
static COMMAND_CATEGORIES: LazyLock<HashMap<&'static str, CommandCategory>> = LazyLock::new(|| {
    ...
    for cmd in [
        ...
        "linsert", "lrem", "ltrim", "lpos", "lmove", "lmpop",
    ] {
...
static COMMAND_ALL_CATEGORIES: LazyLock<HashMap<&'static str, Vec<CommandCategory>>> =
    LazyLock::new(|| {
        ...
        map.insert(
            "subscribe",
            vec![CommandCategory::Pubsub, CommandCategory::Slow],
        );
        map.insert(
            "unsubscribe",
            vec![CommandCategory::Pubsub, CommandCategory::Slow],
        ...
        map.insert(
            "publish",
            vec![CommandCategory::Pubsub, CommandCategory::Fast],
        );
        map.insert(
            "pubsub",
            vec![CommandCategory::Pubsub, CommandCategory::Slow],
        ...
        map.insert(
            "eval",
            vec![CommandCategory::Scripting, CommandCategory::Slow],
        );
        map.insert(
            "evalsha",
            vec![CommandCategory::Scripting, CommandCategory::Slow],
        ...
        map.insert(
            "auth",
            vec![CommandCategory::Connection, CommandCategory::Fast],
        );
        map.insert(
            "ping",
            vec![CommandCategory::Connection, CommandCategory::Fast],
        ...
        map.insert(
            "client",
            vec![CommandCategory::Connection, CommandCategory::Slow],
        );
        map.insert(
            "reset",
            vec![CommandCategory::Connection, CommandCategory::Fast],
        ...
        map.insert(
            "multi",
            vec![CommandCategory::Transaction, CommandCategory::Fast],
        );
        map.insert(
            "exec",
            vec![CommandCategory::Transaction, CommandCategory::Slow],
        );
        map.insert(
            "discard",
            vec![CommandCategory::Transaction, CommandCategory::Fast],
        ...
        map.insert(
            "bgrewriteaof",
            vec![CommandCategory::Admin, CommandCategory::Slow],
        );
        map.insert(
            "bgsave",
            vec![CommandCategory::Admin, CommandCategory::Slow],
        ...
        map.insert(
            "lastsave",
            vec![CommandCategory::Admin, CommandCategory::Fast],
        );
        map.insert(
            "memory",
            vec![CommandCategory::Admin, CommandCategory::Slow],
...
static CATEGORY_COMMANDS: LazyLock<HashMap<CommandCategory, Vec<&'static str>>> =
    LazyLock::new(|| {
