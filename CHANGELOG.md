...
## [0.1.1](https://github.com/frogdb/frogdb/compare/v0.1.0...v0.1.1) (2026-06-17)
...
* **config:** add ConfigParam/DynParam lifecycle infra ([699f85f](https://github.com/frogdb/frogdb/commit/699f85f4ea0bac1bc08650d2c58bf34ad6b18fad))
...
* **replication:** backlog accessors + PartialSyncReplay module ([4daa18a](https://github.com/frogdb/frogdb/commit/4daa18abf8bf14bc861fb8d08f3cd78752b642ab))
* **replication:** gap-free streaming handoff with backlog replay ([312f57f](https://github.com/frogdb/frogdb/commit/312f57fb7b8c21bed2180436f5294ed0bd167569))
* **replication:** grant +CONTINUE through the replay decision ([292d6bb](https://github.com/frogdb/frogdb/commit/292d6bb1794fcc8ca7871e12f808a099babf0fe7))
...
* **config:** dedup maxmemory-policy legal-value list onto a named const ([ccf01e1](https://github.com/frogdb/frogdb/commit/ccf01e136448517fddb8bb0f8194164f7c31c091))
...
* **core:** label eviction sample metric by policy ([01cd1bd](https://github.com/frogdb/frogdb/commit/01cd1bdaa4d2cbcaccfb48af9c864261754caca5))
...
* **replication:** count offset by payload on both ends; stamp GETACK ([944e888](https://github.com/frogdb/frogdb/commit/944e88829c23ea4fc6e6d202e961dd7f5fd63cf8))
...
* **search:** atomic both-or-neither vector load + durable save ([77349eb](https://github.com/frogdb/frogdb/commit/77349ebf953a7a539938c6f333ae714adef1ae87))
* **search:** enforce persist-before-OK in FT.CREATE/ALTER/DROPINDEX ([38258ea](https://github.com/frogdb/frogdb/commit/38258ea5f05779858548afc2e228194b90e88745))
* **search:** enforce vector bijection with all-or-nothing index/delete ([7cf34fd](https://github.com/frogdb/frogdb/commit/7cf34fd506b596c03a736afe45e6c071fa517b67))
...
* **config:** migrate encoding-threshold, misc, and no-op params to ConfigParam (phase 3) ([280e5cc](https://github.com/frogdb/frogdb/commit/280e5cce10191b2b9f80f7797afd94151b3f9367))
* **config:** migrate logging/persistence/replication/slowlog params to ConfigParam (phase 2) ([7065695](https://github.com/frogdb/frogdb/commit/70656956827f600a5f367d9415bd43e36b53a938))
* **config:** migrate memory/eviction params to ConfigParam (phase 1) ([ef8a092](https://github.com/frogdb/frogdb/commit/ef8a092f37de87afc820c0cfb6561e6cea7fc469))
...
* **core:** add EvictionRanker seam and generic pool inserter ([6ba518c](https://github.com/frogdb/frogdb/commit/6ba518c32cf462abaa8b66e5e17b21a83c36cded))
...
* **core:** collapse eviction pool inserters onto ranker ([87568a3](https://github.com/frogdb/frogdb/commit/87568a35efd1ee38d3413b6ed85c709b186b4a7c))
...
* **core:** delete pool inserter triplicates, parametrize tests ([e228f18](https://github.com/frogdb/frogdb/commit/e228f18755880b0877551212703ef092e1ca6d66))
...
* **core:** route shard eviction through the generic ranker ([4be41e9](https://github.com/frogdb/frogdb/commit/4be41e93bb8ad240c25d860b184dfccbe98701b3))
...
* **replication:** introduce OffsetCoordinator seam (phase 0) ([ec025b1](https://github.com/frogdb/frogdb/commit/ec025b14337e658066048999faf9c36580c307e2))
* **replication:** route offset readers through the coordinator (phase 1) ([e3094cb](https://github.com/frogdb/frogdb/commit/e3094cb865ff3fc0f2bac073d838dc215949d11a))
* **replication:** route writers through coordinator, drop dead writer (phase 2) ([1b61649](https://github.com/frogdb/frogdb/commit/1b61649af6816b78e978bd643f30e5c766b7f70f))
* **search:** collapse per-concern persist helpers into one seam ([2a305e8](https://github.com/frogdb/frogdb/commit/2a305e8965cd2c0559af32709d7684ce99ed2a3b))
* **search:** introduce IndexLifecycleManager around per-shard maps ([b23319c](https://github.com/frogdb/frogdb/commit/b23319c07f8b9b242583fe4f48b0a93e892e3766))
* **search:** introduce VectorFieldManager module ([1b77ab6](https://github.com/frogdb/frogdb/commit/1b77ab64b88e18c85d393b52ad4535eb015d873a))
* **search:** move startup recovery behind IndexLifecycleManager::recover ([d041912](https://github.com/frogdb/frogdb/commit/d041912ef4e9077e9bc147fe2b17a29095f6a9e2))
* **search:** route ShardSearchIndex vector state through manager ([90d1c1d](https://github.com/frogdb/frogdb/commit/90d1c1dc615b7cf8e323d6b28a6a5f077f4b2350))
* **server:** add cluster redirect seam (RouteOutcome + redirect module) ([bfb49b6](https://github.com/frogdb/frogdb/commit/bfb49b6aa2531ee67605723681d9c4a9e027fb1b))
...
* **server:** delete second pubsub routing path + reach-ins ([736a411](https://github.com/frogdb/frogdb/commit/736a4115e07ad73a9360843d666f29203b377391))
* **server:** drive shard propagation from param definitions; drop dead legacy setter machinery (phase 4) ([eb4e29e](https://github.com/frogdb/frogdb/commit/eb4e29e93ecea023af03f0cd85a47990da189410))
...
* **server:** route keyed-path redirects through the seam ([88b3fd7](https://github.com/frogdb/frogdb/commit/88b3fd7ac170aded6bd585e9e1138fb660b52136))
...
* **server:** route SSUBSCRIBE redirects through the seam ([92bfc08](https://github.com/frogdb/frogdb/commit/92bfc08375846606f7f215412bcb9bcb132a5612))
