...
|---|---------|-------|------|--------|
| 1 | [Keyspace Notifications](01-keyspace-notifications.md) | 25 | `pubsub_tcl.rs` | Not implemented |
...
| 4 | [Error Statistics](04-error-statistics.md) | 12 | `info_tcl.rs` | Not implemented |
| 5 | [Latency Histograms for INFO](05-latency-histograms.md) | 6 | `info_tcl.rs` | Not implemented |
| 6 | [Client Eviction (`maxmemory-clients`)](06-client-eviction.md) | 22 | `client_eviction_tcl.rs` + `maxmemory_tcl.rs` | Not implemented |
| 7 | [RESP3 Protocol Completion](07-resp3-completion.md) | 22 | mixed | Partial |
| 8 | [CONFIG REWRITE](08-config-rewrite.md) | 5 | `introspection_tcl.rs` | Not implemented |
